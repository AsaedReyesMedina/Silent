                        ...
                        <form action=" {{route('empleados.update',$empleado)}} " method="POST" class="row g-3">
                            ...
                            @method('put')
                              <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="validationDefault01" name="nombre" value=" {{$empleado->primer_nombre}} " required>
                              </div>
                              <div class="col-md-4">
                                <label for="validationDefault02" class="form-label">Apellido</label>
                                <input type="text" class="form-control" id="validationDefault02" value=" {{$empleado->last_name}} " name="apellido" required>
                              </div>
                              <div class="col-md-4">
                                <label for="validationDefaultUsername" class="form-label">Email</label>
                                <div class="input-group">
                                  <input type="email" class="form-control" id="validationDefaultUsername" value=" {{$empleado->email}} " name="email" aria-describedby="inputGroupPrepend2" required>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <label for="validationDefault03" class="form-label">Telefono</label>
                                <input type="text" class="form-control" id="validationDefault03" value=" {{$empleado->telefono}} " name="telefono" required>
                              </div>
                              <div class="col-md-3">
